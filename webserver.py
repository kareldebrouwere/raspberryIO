...
class MotorWebServer(object):
    def __init__(self):
        ...
        self.startHTML = """<form method="get" action="start">
                            ...
                            <button type="button" class="button" value="Make it Turn"</button><br>
                            </form>"""
        self.stopHTML = """<form method="get" action="stop">
                            <button type="button" class="button" value="Stop"</button><br>
                        </form>"""
        self.quarter = """<form method="get" action="kwart">
                            <button type="button" class="button" value="Quarter"</button><br>
                        </form>"""
